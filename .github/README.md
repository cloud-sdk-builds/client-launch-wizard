...
[`@aws-sdk/client-launch-wizard`](https://www.npmjs.com/package/@aws-sdk/client-launch-wizard/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-launch-wizard@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gXbY0D1dNIcpmsC+ekNklEa0+zE9uke83vR7m9EUtMy4VFdUBeK9QLmd5HTLCOTm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-launch-wizard": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-launch-wizard@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-launch-wizard@3.948.0/index.min.mjs": "sha384-gXbY0D1dNIcpmsC+ekNklEa0+zE9uke83vR7m9EUtMy4VFdUBeK9QLmd5HTLCOTm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-launch-wizard/blob/refs/tags/3.948.0/LICENSE
```
